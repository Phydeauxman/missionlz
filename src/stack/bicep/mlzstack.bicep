...
param hubLogStorageSkuName string =  'Standard_LRS' //'Standard_GRS'
...
param firewallClientPublicIPAddressSkuName string = 'Basic'
...
param firewallManagementPublicIPAddressSkuName string = 'Basic'
